...
UWariorAbilitySystemComponent * UWarriorGameplayAbility::GetWariorAbilitySystemComponentFromActorInfo() const
{
    return Cast<UWariorAbilitySystemComponent>(CurrentActorInfo->AbilitySystemComponent);
}
